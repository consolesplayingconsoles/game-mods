# Sonic the Hedgehog (USA, Europe): Random Green Hill

A bonus mod for the Mega Drive game *Sonic the Hedgehog*: Green Hill's level layout is scrambled into an unfamiliar, cursed remix. It ships with **infinite lives**, because the random geometry can be brutal — getting stuck or dying to an impossible jump is part of the joke.

## Download

Shipped in the **Bonus Mods** bundle (alongside Infinite Jump).
...
Patch file: [`Sonic_The_Hedgehog_USA-EU_Random_Green_Hill_v1.0.bps`](https://github.com/consolesplayingconsoles/game-mods/releases/download/sonic-the-hedgehog-usa-eu-bonus-mods-v1.0/Sonic_The_Hedgehog_USA-EU_Random_Green_Hill_v1.0.bps)
...
Green Hill's layout is randomised — expect odd loops, dead ends, and improbable jumps. The other zones are stock. Infinite lives keep the chaos fun rather than frustrating.

## Feedback

[Open an issue](https://github.com/consolesplayingconsoles/game-mods/issues/new) and mention that it is the Random Green Hill mod.
