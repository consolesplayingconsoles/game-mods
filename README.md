...
Patches for retro game mods, organised by console and game.

## See it in action

See what mods Pluto has helped me build, with gameplay on real hardware:
...
This covers the patches and write-ups in this repo. It does not cover the original games or the screenshots of them, which belong to their publishers.
